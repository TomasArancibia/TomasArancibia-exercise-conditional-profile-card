...
function render(variables = {}) {
  ...
  let github = `<li><a href="https://github.com/${
    variables.github ? variables.github : ""
  }"><i class="fab fa-github"></i></a></li>`;
  let linkedin = `<li><a href="https://linkedin.com/${
    variables.linkedin ? variables.linkedin : ""
  }"><i class="fab fa-linkedin"></i></a></li>`;
  let instagram = `<li><a href="https://instagram.com/${
    variables.instagram ? variables.instagram : ""
  }"><i class="fab fa-instagram"></i></a></li>`;
  let location = `<h3>${variables.city ? variables.city : "City"}, ${
    variables.country ? variables.country : "Country"
  }</h3>`;
  let job = `<h2>${variables.role ? variables.role : "Job"}</h2>`;
  let ul = `<ul class="${variables.socialMediaPosition}">`;
